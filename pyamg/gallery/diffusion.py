...
def _symbolic_product_helper():
    ...
    D = sympy.Matrix([[D11, D12, D13], [D21, D22, D23], [D31, D32, D33]])
    grad = sympy.Matrix([['dx', 'dy', 'dz']]).T
    div = grad.T
...
def diffusion_stencil_3d(epsilony=1.0, epsilonz=1.0, theta=0.0, phi=0.0, psi=0.0, type='FD'):
    """
    ...
    epsilony  : float, optional
        ...
        where A = [1 0 0; 0 epsilon_y 0; 0 0 epsilon_z].  The default is isotropic, epsilon=1.0
