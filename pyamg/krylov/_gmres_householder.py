...
def gmres_householder(A, b, x0=None, tol=1e-5, restrt=None, maxiter=None, xtype=None, M=None, callback=None, residuals=None):
    '''
...
if __name__ == '__main__':
    ...
    t1=time.time()
    (x,flag) = gmres_householder(A,b,x0,tol=1e-8,maxiter=240)
    t2=time.time()
