 ...
 * Notes
 * -----
 * Nearly identical to ``gauss_seidel`` with a relaxation parameter ``omega``.
 *
 */
template<class I, class T, class F>
 ...
 * -------
 * None
 *     Array x will be modified in place.
 *
 */
template<class I, class T, class F>
 ...
 * -------
 * None
 *     Array x is modified inplace in an additive, not overwriting fashion.
 *
 */
template<class I, class T, class F>
 ...
 * -------
 * None
 *     Array Tx will be modified inplace.
 *
 */
template<class I, class T, class F>
 ...
 */
template<class I, class T, class F>
void overlapping_asm(      T  x[], const int  x_size,
 ...
 */
template<class I, class T, class F>
void overlapping_rasT(      T  x[], const int  x_size,
                      const T  r[], const int  r_size,
                      const T Tx[], const int Tx_size,
                      const I Tp[], const int Tp_size,
                      const I Sj[], const int Sj_size,
