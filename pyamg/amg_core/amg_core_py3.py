...
def maximal_independent_set_parallel(num_rows: 'int const', Ap: 'int const []', Aj: 'int const []', active: 'int const', C: 'int const', F: 'int const', x: 'int []', y: 'double const []', max_iters: 'int const') -> "int":
...
def maximal_independent_set_k_parallel(num_rows: 'int const', Ap: 'int const []', Aj: 'int const []', k: 'int const', x: 'int []', y: 'double const []', max_iters: 'int const') -> "void":
...
def breadth_first_search(Ap: 'int const []', Aj: 'int const []', seed: 'int const', order: 'int []', level: 'int []') -> "void":
...
def rs_direct_interpolation_pass1(n_nodes: 'int const', Sp: 'int const []', Sj: 'int const []', splitting: 'int const []', Bp: 'int []') -> "void":
