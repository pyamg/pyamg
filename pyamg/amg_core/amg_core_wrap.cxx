...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"vertex_coloring_jones_plassmann", _wrap_vertex_coloring_jones_plassmann, METH_VARARGS, (char *)"vertex_coloring_jones_plassmann(int const num_rows, int const [] Ap, int const [] Aj, int [] x, double [] y) -> int"},
