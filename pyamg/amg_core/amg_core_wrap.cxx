...
#define SWIGTYPE_p_npy_cdouble_wrapper swig_types[3]
#define SWIGTYPE_p_npy_cfloat_wrapper swig_types[4]
...
SWIGINTERN PyObject *_wrap_naive_aggregation(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:naive_aggregation",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
  ...
  result = (int)naive_aggregation<int >(arg1,(int const (*))arg2,(int const (*))arg3,arg4);
  resultobj = SWIG_From_int(static_cast< int >(result));
  {
    if (is_new_object2 && array2) {
      Py_DECREF(array2); 
...
SWIGINTERN PyObject *_wrap_standard_aggregation(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:standard_aggregation",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
  ...
  result = (int)standard_aggregation<int >(arg1,(int const (*))arg2,(int const (*))arg3,arg4);
  resultobj = SWIG_From_int(static_cast< int >(result));
  {
    if (is_new_object2 && array2) {
      Py_DECREF(array2); 
...
SWIGINTERN PyObject *_wrap_overlapping_schwarz_csr__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOOOOO:overlapping_schwarz_csr",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8,&obj9,&obj10)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1
    };
  ...
  arg11 = static_cast< int >(val11);
  overlapping_schwarz_csr<int,float,float >((int const (*))arg1,(int const (*))arg2,(float const (*))arg3,arg4,(float const (*))arg5,(float const (*))arg6,(int const (*))arg7,(int const (*))arg8,(int const (*))arg9,arg10,arg11);
  resultobj = SWIG_Py_Void();
  {
    if (is_new_object1 && array1) {
      Py_DECREF(array1); 
...
SWIGINTERN PyObject *_wrap_overlapping_schwarz_csr__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg11 = static_cast< int >(val11);
  overlapping_schwarz_csr<int,double,double >((int const (*))arg1,(int const (*))arg2,(double const (*))arg3,arg4,(double const (*))arg5,(double const (*))arg6,(int const (*))arg7,(int const (*))arg8,(int const (*))arg9,arg10,arg11);
  resultobj = SWIG_Py_Void();
  {
    if (is_new_object1 && array1) {
      Py_DECREF(array1); 
...
SWIGINTERN PyObject *_wrap_overlapping_schwarz_csr__SWIG_3(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg11 = static_cast< int >(val11);
  overlapping_schwarz_csr<int,npy_cfloat_wrapper,float >((int const (*))arg1,(int const (*))arg2,(npy_cfloat_wrapper const (*))arg3,arg4,(npy_cfloat_wrapper const (*))arg5,(npy_cfloat_wrapper const (*))arg6,(int const (*))arg7,(int const (*))arg8,(int const (*))arg9,arg10,arg11);
  resultobj = SWIG_Py_Void();
  {
    if (is_new_object1 && array1) {
      Py_DECREF(array1); 
...
SWIGINTERN PyObject *_wrap_overlapping_schwarz_csr__SWIG_4(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg11 = static_cast< int >(val11);
  overlapping_schwarz_csr<int,npy_cdouble_wrapper,double >((int const (*))arg1,(int const (*))arg2,(npy_cdouble_wrapper const (*))arg3,arg4,(npy_cdouble_wrapper const (*))arg5,(npy_cdouble_wrapper const (*))arg6,(int const (*))arg7,(int const (*))arg8,(int const (*))arg9,arg10,arg11);
  resultobj = SWIG_Py_Void();
  {
    if (is_new_object1 && array1) {
      Py_DECREF(array1); 
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'overlapping_schwarz_csr'.\n  Possible C/C++ prototypes are:\n    overlapping_schwarz_csr<(int,float,float)>(int const [],int const [],float const [],float [],float const [],float const [],int const [],int const [],int const [],int,int)\n    overlapping_schwarz_csr<(int,double,double)>(int const [],int const [],double const [],double [],double const [],double const [],int const [],int const [],int const [],int,int)\n    overlapping_schwarz_csr<(int,npy_cfloat_wrapper,float)>(int const [],int const [],npy_cfloat_wrapper const [],npy_cfloat_wrapper [],npy_cfloat_wrapper const [],npy_cfloat_wrapper const [],int const [],int const [],int const [],int,int)\n    overlapping_schwarz_csr<(int,npy_cdouble_wrapper,double)>(int const [],int const [],npy_cdouble_wrapper const [],npy_cdouble_wrapper [],npy_cdouble_wrapper const [],npy_cdouble_wrapper const [],int const [],int const [],int const [],int,int)\n");
  return NULL;
}
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"signof", _wrap_signof, METH_VARARGS, NULL},
	 { (char *)"conjugate", _wrap_conjugate, METH_VARARGS, NULL},
	 { (char *)"real", _wrap_real, METH_VARARGS, NULL},
	 { (char *)"imag", _wrap_imag, METH_VARARGS, NULL},
	 { (char *)"mynorm", _wrap_mynorm, METH_VARARGS, NULL},
	 { (char *)"mynormsq", _wrap_mynormsq, METH_VARARGS, NULL},
	 { (char *)"zero_real", _wrap_zero_real, METH_VARARGS, NULL},
	 { (char *)"zero_imag", _wrap_zero_imag, METH_VARARGS, NULL},
	 { (char *)"cljp_naive_splitting", _wrap_cljp_naive_splitting, METH_VARARGS, NULL},
	 { (char *)"naive_aggregation", _wrap_naive_aggregation, METH_VARARGS, NULL},
	 { (char *)"standard_aggregation", _wrap_standard_aggregation, METH_VARARGS, NULL},
	 { (char *)"rs_cf_splitting", _wrap_rs_cf_splitting, METH_VARARGS, NULL},
	 { (char *)"rs_direct_interpolation_pass1", _wrap_rs_direct_interpolation_pass1, METH_VARARGS, NULL},
	 { (char *)"rs_direct_interpolation_pass2", _wrap_rs_direct_interpolation_pass2, METH_VARARGS, NULL},
	 { (char *)"satisfy_constraints_helper", _wrap_satisfy_constraints_helper, METH_VARARGS, NULL},
	 { (char *)"calc_BtB", _wrap_calc_BtB, METH_VARARGS, NULL},
	 { (char *)"incomplete_BSRmatmat", _wrap_incomplete_BSRmatmat, METH_VARARGS, NULL},
	 ...
	 { (char *)"min_blocks", _wrap_min_blocks, METH_VARARGS, NULL},
	 { (char *)"bsr_gauss_seidel", _wrap_bsr_gauss_seidel, METH_VARARGS, NULL},
	 { (char *)"bsr_jacobi", _wrap_bsr_jacobi, METH_VARARGS, NULL},
	 { (char *)"gauss_seidel", _wrap_gauss_seidel, METH_VARARGS, NULL},
	 { (char *)"jacobi", _wrap_jacobi, METH_VARARGS, NULL},
	 { (char *)"block_jacobi", _wrap_block_jacobi, METH_VARARGS, NULL},
	 { (char *)"block_gauss_seidel", _wrap_block_gauss_seidel, METH_VARARGS, NULL},
	 { (char *)"gauss_seidel_indexed", _wrap_gauss_seidel_indexed, METH_VARARGS, NULL},
	 { (char *)"jacobi_ne", _wrap_jacobi_ne, METH_VARARGS, NULL},
	 { (char *)"gauss_seidel_ne", _wrap_gauss_seidel_ne, METH_VARARGS, NULL},
	 { (char *)"gauss_seidel_nr", _wrap_gauss_seidel_nr, METH_VARARGS, NULL},
	 { (char *)"overlapping_schwarz_csr", _wrap_overlapping_schwarz_csr, METH_VARARGS, NULL},
	 { (char *)"extract_subblocks", _wrap_extract_subblocks, METH_VARARGS, NULL},
	 { (char *)"apply_householders", _wrap_apply_householders, METH_VARARGS, NULL},
	 { (char *)"householder_hornerscheme", _wrap_householder_hornerscheme, METH_VARARGS, NULL},
	 { (char *)"apply_givens", _wrap_apply_givens, METH_VARARGS, NULL},
	 { (char *)"maximal_independent_set_serial", _wrap_maximal_independent_set_serial, METH_VARARGS, NULL},
	 { (char *)"maximal_independent_set_parallel", _wrap_maximal_independent_set_parallel, METH_VARARGS, NULL},
	 { (char *)"maximal_independent_set_k_parallel", _wrap_maximal_independent_set_k_parallel, METH_VARARGS, NULL},
	 { (char *)"vertex_coloring_mis", _wrap_vertex_coloring_mis, METH_VARARGS, NULL},
	 { (char *)"vertex_coloring_jones_plassmann", _wrap_vertex_coloring_jones_plassmann, METH_VARARGS, NULL},
	 { (char *)"vertex_coloring_LDF", _wrap_vertex_coloring_LDF, METH_VARARGS, NULL},
	 { (char *)"breadth_first_search", _wrap_breadth_first_search, METH_VARARGS, NULL},
	 { (char *)"connected_components", _wrap_connected_components, METH_VARARGS, NULL},
	 { (char *)"bellman_ford", _wrap_bellman_ford, METH_VARARGS, NULL},
	 { (char *)"lloyd_cluster", _wrap_lloyd_cluster, METH_VARARGS, NULL},
	 { (char *)"fit_candidates", _wrap_fit_candidates, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
