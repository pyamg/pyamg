...
void _classical_strength_of_connection(
     I n_row,
     F theta,
     py::array_t<I> & Ap,
     py::array_t<I> & Aj,
...
const T *_Ax = py_Ax.data();
 ...
 return classical_strength_of_connection<I, T, F>(
     n_row,
     theta,
     _Ap, Ap.size(),
     _Aj, Aj.size(),
...
PYBIND11_PLUGIN(ruge_stuben) {
    py::module m("ruge_stuben", R"pbdoc(
    ...
    m.def("classical_strength_of_connection", &_classical_strength_of_connection<int, float, float>,
    ...
    m.def("classical_strength_of_connection", &_classical_strength_of_connection<int, double, double>,
        py::arg("n_row"), py::arg("theta"), py::arg("Ap").noconvert(), py::arg("Aj").noconvert(), py::arg("Ax").noconvert(), py::arg("Sp").noconvert(), py::arg("Sj").noconvert(), py::arg("Sx").noconvert());
    m.def("classical_strength_of_connection", &_classical_strength_of_connection<int, std::complex<float>, float>,
        py::arg("n_row"), py::arg("theta"), py::arg("Ap").noconvert(), py::arg("Aj").noconvert(), py::arg("Ax").noconvert(), py::arg("Sp").noconvert(), py::arg("Sj").noconvert(), py::arg("Sx").noconvert());
    m.def("classical_strength_of_connection", &_classical_strength_of_connection<int, std::complex<double>, double>,
        py::arg("n_row"), py::arg("theta"), py::arg("Ap").noconvert(), py::arg("Aj").noconvert(), py::arg("Ax").noconvert(), py::arg("Sp").noconvert(), py::arg("Sj").noconvert(), py::arg("Sx").noconvert(),
R"pbdoc(
