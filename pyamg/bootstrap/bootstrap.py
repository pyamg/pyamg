...
from pyamg.classical.interpolate import direct_interpolation, ls_interpolation
from pyamg.classical import split
from pyamg.classical.cr import CR

__all__ = ['bootstrap_solver']
...
def bootstrap_solver(A,
    ...
    """Create a multilevel solver using Bootstrap AMG
    ...
    >>> ml = bootstrap_solver(A,max_coarse=3)
    ...
    References
    ----------
    Brandt, Achi, James J. Brannick, Karsten Kahl, and Irene Livshits. 
    "Bootstrap AMG." SIAM Journal on Scientific Computing 33 (2011): 612-632.
